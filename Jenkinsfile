pipeline {
    ...
    stages {
        ...
        // ------------------------------------------------------------
        stage('Build App (TypeScript - build in Jenkins)') {
            agent none
            steps {
                ansiColor('xterm') {
                    script {
                        docker.image(
                            ...
                            sh '''
                                ...
                                echo "⚙️ Building TypeScript app..."
                                pnpm build
                                ...
                                cp package.json pnpm-lock.yaml build_output/
                                cp Dockerfile build_output/
                    ...
                    sh '''
                        ...
                        ssh -o StrictHostKeyChecking=no \
                          ...
                          "$REMOTE" "
                            ...
                            bash /home/fink/Workspace/crowdfunding/deploy_scripts/deploy_be.sh
                          "
                    '''
                }
            }
